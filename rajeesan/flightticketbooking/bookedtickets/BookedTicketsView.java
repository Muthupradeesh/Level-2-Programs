...
public class BookedTicketsView {
	...
	public void start()
	{
		...
		{
			System.out.println(" Passenger Name"+temp.get(i).getPassengerName()+"  || "+" Passenger Id"+temp.get(i).getPassengerId()
					+" || "+" AllotedSeat "+temp.get(i).getPassengerName()+" || "+" Passenger PNR : "+temp.get(i).getPnr()+" || "+"travelling Flight No "+temp.get(i).getFlightNo());
			System.out.println();
		}
	}
